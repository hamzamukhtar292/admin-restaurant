<p>Ya sara Code Tayyab Ali na Comment kiya howaS</p>
/*"use client";
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gradient-to-r from-yellow-100 via-red-100 to-yellow-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800">
      <form
        ...
        className="w-96 p-8 shadow-lg rounded-lg bg-white text-black dark:bg-gray-700 dark:text-white"
      >
        ...
        <button
          type="submit"
          className="w-full p-3 bg-red-600 text-white rounded hover:bg-red-700 transition dark:bg-red-500 dark:hover:bg-red-400"
        >
          Login
        </button>
      </form>
